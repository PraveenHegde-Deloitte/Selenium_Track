...
public class minitest extends generic{
    ...
    {
        try {
            xls1 = new ExcelData("C:\\Users\\prhegde\\IdeaProjects\\assignment_4_5\\src\\main\\resources\\saucedemo.xlsx");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    String UN = xls1.getData(0,0,0);
    String Pass = xls1.getData(0,0,1);
